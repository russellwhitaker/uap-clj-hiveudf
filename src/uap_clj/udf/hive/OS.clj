...
(defn #^Text -evaluate
  "Extract O/S family<tab>major number<tab>minor number<tab>patch<tab>patch_minor number
   ...
   USAGE: after adding the .jar file from this project, create your temporary function
     ...
     to break into 5 fields in your query, returning a Hive array<string> of length 5 which
